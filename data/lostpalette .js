/* ==============================================================
   GENETIGZ — COLLECTION DATA: LOST PALETTE
...
(function () {
  ...
  window.GZ_COLLECTIONS.push({
    slug: 'lostpalette',
    name: 'Lost Palette',
    description: 'From Fresco to Fabric',
    products: [
      // TODO: add real products here, e.g.
      // {
      //   id: 'lp-001', code: 'LP-001', category: 'lostpalette',
      //   name: 'Product Name',
      ...
      //   notes: 'Oversized fit.',
      //   images: { front: 'images/collections/lostpalette/product-name.png' }
      // }
    ]
  });
